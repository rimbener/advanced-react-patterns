...
function useControlledSwitchWarning(
  ...
  const isControlled = (controlPropValue = controlPropValue != null)
  ...
  }, [componentName, controlPropName, isControlled, onWasControlled])
}
...
function Toggle({on: controlledOn, onChange, initialOn, readOnly, reducer}) {
